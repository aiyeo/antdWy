...
import {ACCEPT_detail,getProvinces,getCitys,getAreas,getProvinces1,getCitys1,getAreas1,CON_carrierList,CON_assign} from '../../services/consignment';
import {arrList} from '../../utils/fun_config';

export default {
  namespace: 'consignmentdetailtrans',
  state: {
  	item:{},
  	provinceData:{},
  	cityData:{},
